...
public class PlayerController : MonoBehaviour
{
    ...
    void HandleMovement()
    {
        ...
        if (slowWalk)
        {
            targetSpeed = (Input.GetKey(KeyCode.LeftShift)) ? runSpeed * moveAmount : slowWalkSpeed * moveAmount;

        }
        else
        {
            targetSpeed = (Input.GetKey(KeyCode.LeftShift)) ? runSpeed * moveAmount : walkSpeed * moveAmount;
        }
